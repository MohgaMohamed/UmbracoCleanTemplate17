...
namespace  FayoumGovPortal.Core.Umbraco.SEO
{
    public class SEOService : ISEOService
    {
        ...
        {
            string metaTitlePropertyAlias = nameof(ISeoContentComposition.MetaTitle).ToFirstLower();
        ...
        {
            string metaDescriptionPropertyAlias = nameof(ISeoContentComposition.MetaDescription).ToFirstLower();
        ...
        {
            string metaKeywordsPropertyAlias = nameof(ISeoContentComposition.MetaKeywords).ToFirstLower();
        ...
        {
            string socialShareImagePropertyAlias = nameof(ISeoContentComposition.SocialShareImage).ToFirstLower();
